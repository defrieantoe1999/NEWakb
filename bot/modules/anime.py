...
• `/mang`*:* search manga
'''
    update.effective_message.reply_photo("https://telegra.ph/file/a0c24194bad79f5ee1f88.jpg", help_string, parse_mode=ParseMode.MARKDOWN)


ANIME_HANDLER = CommandHandler("anim", anime)
CHARACTER_HANDLER = CommandHandler("chara", character)
MANGA_HANDLER = CommandHandler("mang", manga)
